...
export default function Spotlight({ onAdd, onDelete, notes, setActive, active, isSpot }) {
  ...
  let commands = [
    {
      id: 0,
      icon: <svg width="14" height="13" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      id: 1,
      icon: <svg width="14" height="17" viewBox="0 0 18 21" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      id: 2,
      icon: <svg width="14" height="13" viewBox="0 0 22 21" fill="none" xmlns="http://www.w3.org/2000/svg">
