    ...
    <>
      ...
      <nav className='top'>
        ...
        <div className='top__menu'>
          <button type='button' aria-label='Share note' onClick={() => setShare(!share)}>
