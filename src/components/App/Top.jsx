...
export default function Top({ handleSide, side }) {
  const { active, getActive, user, onUpdate } = UserAuth()
  ...
  const Share = () => {
    if (getActive()) {
      const link = window.location.origin.toString() + '/#/' + getActive().id
        ...
        <div className='share'>
          <div className='share__container' ref={ref}>
            <div className='share__container-header'>
              <h3>Share</h3>
              <p>Here is your unique note QR code that will direct people to your note when scanned.</p>
            </div>
            <QRCode 
              id='qr'
              className='share__container-qr'
              title='Notebucket note'
              value={link} 
              bgColor='#FFF'
              fgColor='#000'
              size={128}
    ...
    return (
      <div className='submenu'>
        ...
        <div className='submenu__actions'>
          ...
          <div className='submenu__actions-export'>
            <label onClick={handleExport}>
              <svg width='13' height='17' viewBox='0 0 16 20' fill='none' xmlns='https://www.w3.org/2000/svg'>
        ...
        <ul className='submenu__info'>
          ...
          <li><a href='https://github.com/Artezi0/note'>
            <svg width='14' height='14' viewBox='0 0 19 19' fill='none' xmlns='https://www.w3.org/2000/svg'>
    ...
    <>
      ...
      <nav className='top'>
        <div className='top__info'>
          {!side &&
          <>
            <button type='button' aria-label='Toggle sidebar' className='top__info-btn' onClick={handleSide} data-tip data-for='sideTip'>
          ...
          <p className='top__info-filename' style={{color: getActive() ? '#000' : '#19171199',}}>
            {active ? getActive().title : 'No document'}
          </p>
        </div>
        <div className='top__menu'>
          <button type='button' aria-label='Share note' data-tip data-for='shareTip' className='top__menu-share' onClick={() => setShare(!share)}>
          ...
          <ReactTooltip id='shareTip' effect='solid' type='dark' place='bottom' className='tooltip' backgroundColor='#000' arrowColor='transparent'>
            <span>Share note</span>
          </ReactTooltip>
          <button type='button' aria-label='Toggle read-only' data-tip data-for='readTip' className='top__menu-readonly' onClick={() => isRead(!read) & onUpdate({...getActive(), isRead: read, lastModified: Date.now()})}>
            <svg width='22' height='22' viewBox='0 0 28 28' fill='none' xmlns='https://www.w3.org/2000/svg'>
          ...
          <button type='button' aria-label='Toggle submenu' data-tip data-for='subTip' className='top__menu-submenu' onClick={() => isSubmenu(!submenu)}>
            <svg width='22' height='22' viewBox='0 0 28 28' fill='none' xmlns='https://www.w3.org/2000/svg'>
